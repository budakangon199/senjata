...
// Konfigurasi parameter login (ganti ke 'id' atau lainnya jika perlu)
$loginParam = 'th-TH';

// Fungsi untuk menghasilkan daftar 100 emoji (statis)
function getRandomEmojiList($count = 100) {
    $emoji_list = array(
        '😀', '😁', '😂', '🤣', '😃', '😄', '😅', '😆', '😉', '😊',
        '😋', '😎', '😍', '😘', '🥰', '😗', '😙', '😚', '🙂', '🤗',
        '🤩', '🤔', '🤨', '😐', '😑', '😶', '🙄', '😏', '😣', '😥',
    ...
    $emoji_subset = array();
    for ($i = 0; $i < min($count, count($emoji_list)); $i++) {
        $emoji_subset[] = $emoji_list[$i % count($emoji_list)];
    }
    
    return $emoji_subset;
}

// Fungsi untuk menghasilkan satu emoji berdasarkan brand
function getEmojiByBrand($emoji_list, $brand) {
    $index = crc32($brand) % count($emoji_list);
    return $emoji_list[$index];
}

// Fungsi untuk menghasilkan 100 judul bertema slot dalam bahasa Thailand (statis)
function getRandomSlotTitles($count = 100) {
    $themes = array( 
        'ทางเข้า PG SLOT เว็บตรง ล็อกอินง่าย ได้เงินจริง',
        'สมัครสล็อต PG วันนี้ รับโบนัสแตกทันที',
        'PG SLOT มือถือ แตกง่ายทุกเกม เล่นได้ทุกที่',
        'เว็บตรง PG SLOT ไม่ผ่านเอเย่นต์ แตกบ่อยที่สุด',
        'คาสิโนออนไลน์ PG รางวัลใหญ่แจกทุกวัน',
        'สล็อต PG แตกง่าย ได้เงินจริงทุกยูสเซอร์',
        'เข้าสู่ระบบสล็อต PG เว็บแท้ แตกไวทุกไม้',
        'เกมคาสิโน PG SLOT เล่นง่าย จ่ายเต็มยอด',
        'สล็อตมือถือ PG เล่นเพลิน แตกไม่หยุด',
        'สมัครสมาชิก PG SLOT รับฟรีสปินทันที',
        'สล็อตแตกไว PG SLOT แตกหนักทุกชั่วโมง',
        'PG SLOT เว็บตรง โบนัสเยอะ แตกง่ายสุด',
        'เกม PG Soft สล็อตแตกง่ายที่สุด 2025',
        'เว็บตรงสล็อต PG แจ็คพอตใหญ่ ลุ้นทุกวัน',
        'เล่นสล็อต PG มือถือ ง่าย สะดวก ปลอดภัย',
        'PG SLOT เว็บแท้ แตกง่าย ถอนได้จริง',
        'เข้าสู่ระบบวันนี้ รับเครดิตฟรี PG SLOT',
        'สมัครฟรี PG SLOT เล่นได้ทันทีไม่ต้องรอ',
        'PG SLOT สล็อตแตกหนัก รองรับทุกระบบ',
        'เว็บสล็อต PG แท้ รวยเร็วในไม่กี่นาที',
        'สล็อต PG ระบบออโต้ แตกไว ถอนได้จริง',
        'เกมยอดนิยม PG SLOT แตกบ่อยที่สุด',
        'เว็บตรง PG SLOT ล็อกอินรวดเร็ว แตกทุกไม้',
        'สล็อต PG Soft ลุ้นแจ็คพอตทุกการสปิน',
        'คาสิโน PG SLOT รวมเกมแตกง่ายไว้ในที่เดียว'
    );
    
    
    $objects = array(
        'มังกรทอง', 'เพชรระยิบ', 'ผลไม้โชคดี', 'สมบัติลับ', 'เหรียญมหัศจรรย์',
        'นางฟ้าแห่งโชค', 'ราชาสล็อต', 'ดวงดาวนำโชค', 'หีบสมบัติ', 'สายรุ้งเงิน',
        'หมาป่าเงิน', 'สิงโตทอง', 'นกยูงเพลิง', 'ม้าศักดิ์สิทธิ์', 'ต้นไม้โชค'
    );
    ...
    for ($i = 0; $i < $count; $i++) {
        ...
        $titles[] = "สล็อต $object $theme";
    }
    
    return $titles;
}

// Fungsi untuk menghasilkan satu judul berdasarkan brand
function getTitleByBrand($titles, $brand) {
    $index = crc32($brand) % count($titles);
    return $titles[$index];
}

// Fungsi untuk menghasilkan 100 deskripsi dalam bahasa Thailand (statis)
function getRandomDescriptions($titles, $count = 100) {
    $descriptions_templates = array( 
        'ล็อกอินหรือสมัคร PG SLOT เว็บตรงวันนี้ รับโบนัสฟรีทันที เล่นง่าย จ่ายจริง ปลอดภัย 100%',
        'เริ่มต้นความรวยกับสล็อต PG สมัครฟรี รับโบนัสทันที เล่นได้ทุกที่ทุกเวลา',
        'เล่นเกมสล็อต PG บนมือถือ แตกง่ายทุกเกม รองรับทั้ง iOS และ Android',
        'PG SLOT เว็บตรงไม่ผ่านเอเย่นต์ มั่นคง ปลอดภัย เกมสล็อตแตกบ่อยทุกวัน',
        'ลุ้นรางวัลใหญ่จากคาสิโนออนไลน์ PG ทุกวัน สมัครง่าย ฝากถอนไว',
        'PG SLOT สล็อตแตกง่าย แตกไว ได้เงินจริงทุกการหมุน สะดวกทุกช่องทาง',
        'เข้าสู่ระบบ PG SLOT เว็บแท้ รับโบนัสแตกง่ายทันที พร้อมระบบออโต้เต็มรูปแบบ',
        'สนุกกับเกมคาสิโน PG SLOT เล่นง่าย ได้เงินเร็ว ลุ้นรางวัลไม่จำกัด',
        'เล่นสล็อต PG ผ่านมือถือ เล่นได้ทุกที่ ลื่นไหล ไม่มีสะดุด แตกบ่อยที่สุด',
        'เพียงสมัคร PG SLOT วันนี้ รับฟรีสปินไม่อั้น เล่นได้จริง ถอนเงินได้ทันที',
        'PG SLOT สล็อตแตกหนัก แตกทุกชั่วโมง รับรางวัลเต็มไม่มีอั้น',
        'เล่น PG SLOT เว็บตรง แตกง่าย แตกบ่อย ระบบเสถียรและปลอดภัย',
        'รวมเกมสล็อตแตกง่ายจากค่าย PG Soft เล่นสนุก พร้อมกำไรทุกเกม',
        'เว็บสล็อต PG แท้ แตกง่าย ลุ้นแจ็คพอตใหญ่ทุกวัน ไม่มีขั้นต่ำ',
        'เล่นสล็อต PG บนมือถือได้ทุกเวลา ระบบเร็ว โบนัสแตกทุกเกม',
        'PG SLOT เว็บแท้จากต่างประเทศ เชื่อถือได้ แตกจริง จ่ายจริง',
        'เข้าสู่ระบบวันนี้ รับเครดิตฟรี PG SLOT เล่นได้ทุกเกม ไม่มีเงื่อนไขซับซ้อน',
        'สมัครสมาชิก PG SLOT ฟรีวันนี้ พร้อมเล่นเกมแตกง่ายได้ทันที',
        'เล่นเกม PG SLOT ระบบออโต้ สะดวก ฝากถอนเร็ว ไม่มีขั้นต่ำ',
        'สล็อต PG แตกง่าย รวยเร็วในไม่กี่นาที เล่นได้ทุกเพศทุกวัย',
        'PG SLOT แตกง่ายทุกเกม ถอนเงินไว ระบบมั่นคงปลอดภัย',
        'เกมสล็อต PG ยอดนิยม โบนัสแตกบ่อย แตกทุกช่วงเวลา',
        'ล็อกอิน PG SLOT ง่ายดาย รองรับมือถือทุกระบบ แตกบ่อยไม่มีหยุด',
        'สล็อต PG Soft ลุ้นเงินรางวัลมหาศาล แตกง่ายทุกไม้',
        'รวมเกมคาสิโนออนไลน์ PG SLOT เล่นง่าย ได้เงินจริง แตกจริงทุกเกม'
    );
    
    
    $descriptions = array();
    for ($i = 0; $i < $count; $i++) {
        $title = isset($titles[$i % count($titles)]) ? $titles[$i % count($titles)] : 'สล็อตโชคดี';
        $template = $descriptions_templates[$i % count($descriptions_templates)];
        $descriptions[] = sprintf($template, $title);
    }
    
    return $descriptions;
}

// Fungsi untuk menghasilkan satu deskripsi berdasarkan brand
function getDescriptionByBrand($descriptions, $brand) {
    $index = crc32($brand) % count($descriptions);
    return $descriptions[$index];
}

// Fungsi untuk membaca brand dari readme.txt
function readBrands($filename) {
    if (!file_exists($filename)) {
        die("Error: File $filename tidak ditemukan!");
    }
    return array_values(array_filter(file($filename, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES)));
}

// Fungsi untuk menghasilkan satu brand acak (sebagai fallback)
function getRandomBrand($brands) {
    return $brands[array_rand($brands)];
}

// Fungsi untuk mendeteksi base URL secara otomatis
function getUrlPath() {
...
// Fungsi untuk menghasilkan URL tunnel
function generateTunnelUrl($urlPath, $brand, $param = 'th-TH') {
    $encoded_brand = str_replace(' ', '+', $brand);
    return "$urlPath/?$param=$encoded_brand";
}
...
// Main program
// Dapatkan base URL secara otomatis
$urlPath = getUrlPath();

// Baca brand dari readme.txt
$brands = readBrands('readme.txt');

// Dapatkan 100 emoji dan simpan ke $emoji_list
$emoji_list = getRandomEmojiList(100);

// Dapatkan 100 judul bertema slot dan simpan ke $title_list
$title_list = getRandomSlotTitles(100);

// Dapatkan 100 deskripsi dan simpan ke $deskripsi_list
$deskripsi_list = getRandomDescriptions($title_list, 100);

// Generate URL untuk setiap brand dan simpan ke array
$urls = array();
foreach ($brands as $BRANDS) {
    $urls[] = generateTunnelUrl($urlPath, $BRANDS, $loginParam);
}

// Tentukan brand berdasarkan URL parameter
$BRANDS = isset($_GET[$loginParam]) && in_array($_GET[$loginParam], $brands) 
    ? $_GET[$loginParam] 
    : getRandomBrand($brands);

// Tentukan judul, deskripsi, dan emoji berdasarkan brand
$title = getTitleByBrand($title_list, $BRANDS);
$deskripsi = getDescriptionByBrand($deskripsi_list, $BRANDS);
$emoji = getEmojiByBrand($emoji_list, $BRANDS);

// Tentukan canonical URL (ubah di sini sesuai keinginan)
$urlPath = 'https://chayamengrai.chiangrai.police.go.th/video/?' . $loginParam . '=' . str_replace(' ', '+', $BRANDS);

// Buat sitemap.xml berdasarkan $urls (hanya dari readme.txt)
generateSitemap($urls);

// Tentukan URL AMP (ubah di sini sesuai keinginan)
$ampnya = 'https://chayamengrai-chiangrai-police.pages.dev/'; // Ganti dengan URL AMP yang kamu inginkan
?>
<!doctype html>
...
<meta name="title" content="<?php echo $BRANDS; ?> <?php echo $emoji; ?> <?php echo $title; ?>" />
<title><?php echo $BRANDS; ?> <?php echo $emoji; ?> <?php echo $title; ?></title>
<meta name="og:site_name" content="<?php echo $BRANDS; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> <?php echo $deskripsi; ?>" /> 
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />
<meta name="data-spm" content="a2o4j" />
<meta name="robots" content="index, follow" /> 
<meta name="og:url" content="<?php echo $urlPath; ?>" />
<meta name="og:title" content="<?php echo $BRANDS; ?> <?php echo $emoji; ?> <?php echo $title; ?>" />
<meta name="og:type" content="product" />
<meta name="og:description" content="<?php echo $BRANDS; ?> <?php echo $deskripsi; ?>" />
<meta name="og:image" content="https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg" />
<link rel="shortcut icon" href="https://cdn-icons-png.flaticon.com/128/7915/7915382.png" />
<link rel="canonical" href="<?php echo $urlPath; ?>" />
<link rel="amphtml" href="<?php echo $ampnya; ?>/?login=<?php echo $BRANDS; ?>" />
...
<img src="https://res.cloudinary.com/dfmrracoo/image/upload/v1744783377/logouvo88_dnmb0s.png" ></img>
</a>
</div>
<script
...
<script
type='text/javascript'>window.navmet.push({ key: 'Search', end: +new Date(), begin: window.navmet.tmp });</script></div>
<div class='nav-right'>
<script type='text/javascript'>window.navmet.tmp = +new Date();</script>
...
<a href="https://t.ly/kBUwz" aria-label="0 items in shopping basket"
class="nav-a nav-a-2nav-progressive-attribute" id="nav-cart">
...
<script type='text/javascript'>window.navmet.tmp = +new Date();</script>
<a href="<?php echo $urlPath; ?>" class="nav-a  " tabindex="0"
data-csa-c-type="link" data-csa-c-slot-id="nav_cs_0"
data-csa-c-content-id="nav_cs_bestsellers"><?php echo $BRANDS; ?></a>
<a href="<?php echo $urlPath; ?>" class="nav-a  " tabindex="0" data-csa-c-type="link"
...
<script type="text/javascript">
var iUrl = "https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg";
                                                                ...
                                                                data-action="a-button-group" role="radiogroup"> <span
                                                                    ...
                                                                    class="a-button a-button-groupfirst a-spacing-none a-button-base"><span
                                                                        class="a-button-inner"><a
                                                                            href="https://t.ly/kBUwz"name="submit.add-to-registry.wishlist.unrecognized"
                                                                ...
                                                                <div class="a-row a-text-ellipsis">
                                                                    <div id="atwl-inline-sucess-msg"
                                                                        ...
                                                                        href="/gp/registry/wishlist/"> <span
                                                                            ...
                                                                            class="a-size-base" role="alert"> </span></a>
                                                                </div>
                                                            </div>
                        ...
                        <div id="olpLinkWidget_feature_div" class="celwidget" data-feature-name="olpLinkWidget"
                            ...
                            <div id="all-offers-display" class="a-section">
                                <div id="all-offers-display-spinner" class="a-spinner-wrapper aok-hidden"><span
                                        class="a-spinner a-spinner-medium"></span></div>
                                <form method="get" action="" autocomplete="off"
                                    class="aok-hidden all-offers-display-params"> <input type="hidden" name=""value="true" id="all-offers-display-reload-param" /> <input type="hidden"
                        ...
                        <div id="imageBlock_feature_div" class="celwidget" data-feature-name="imageBlock"
                            ...
                            <div id="imageBlock" data-csa-c-content-id="image-block-desktop"
                                ...
                                <div class="a-fixed-left-grid">
                                    <div class="a-fixed-left-grid-inner" style="padding-left:40px"><div class="a-text-center a-fixed-left-grid-col regularImageBlockViewLayout a-col-right"
                                            ...
                                            <div
                                                ...
                                                <div id="main-image-container" class="a-dynamic-image-container">
                                                            ...
                                                            class="image item itemNo0 selected maintain-height"><span
                                                                class="a-list-item"> <span class="a-declarative"
                                                                    ...
                                                                    <div id="imgTagWrapperId" class="imgTagWrapper">
                                                                        <img alt="Layarkaca21"
                                                                            src="https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg"
                                                                            data-old-hires="https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg"
                                                                            ...
                                                                            data-a-dynamic-image="{&quot;https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg&quot;:[450,450],&quot;https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg&quot;:[679,679],&quot;https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg&quot;:[425,425],&quot;https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg&quot;:[466,466],&quot;https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg&quot;:[522,522],&quot;https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg&quot;:[569,569],&quot;https://pub-b6d73237202446eebc11735fa6244a59.r2.dev/18.jpg&quot;:[355,355]}"
                                                                            style="max-width:679px;max-height:679px;" />
                                                                    </div>
                                                                </span> </span></li>
                                                        <li class="mainImageTemplate template"><span
                                                                class="a-list-item"> <span class="a-declarative"data-action="main-image-click"
                                                                    data-csa-c-type="widget"
                                                                    data-csa-c-func-deps="aui-da-main-image-click"
                                                                    data-main-image-click="{}" data-ux-click="">
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        var dynamicImageMaxWidth = 679;dynamicImageMaxHeight = landingImage.naturalHeight;
                                    ...
                                    <div id="ivDimensionTab" class="iv-box iv-box-tab iv-tab-content" role="tabpanel"
                                        ...
                                        <div class="iv-box-inner">
                                            <div id="ivMainDimensions" data-csa-c-type="modal"
                                                data-csa-c-component="imageBlock"
                                                data-csa-c-content-id="image-block-immersive-view-dimensions-tab"><div id="ivStageDimensions">
                        ...
                        <div id="buffetServiceCardAtf_feature_div" class="celwidget"
                            ...
                            data-csa-c-is-in-initial-active-row="false"><div class="celwidget c-f"
                                ...
                                <style>
                                    ...
                                    ._YnVmZ_ss-ctr_p2MM3 {
                                        -webkit-box-orient: vertical;
                                        -webkit-box-direction: normal;display: -webkit-box;
                                        display: -ms-flexbox;
                                        display: flex;
                                        -ms-flex-direction: column;
                                        flex-direction: column;
                        ...
                        <div id="title_feature_div" class="celwidget" data-feature-name="title" data-csa-c-type="widget"
                            ...
                            <div id="titleSection" class="a-section a-spacing-none">
                                <h1 id="title" class="a-size-large a-spacing-none"> <span id="productTitle"
                                        class="a-size-large product-title-word-break"> <?php echo $BRANDS; ?> <?php echo $emoji; ?> <?php echo $title; ?> </span> </h1>
            ...
            */
                        ...
                        <div id="ask_feature_div" class="celwidget" data-feature-name="ask" data-csa-c-type="widget"
                            ...
                            <span data-csa-c-type="widget" data-csa-c-slot-id="ask-atf-link-search-this-page"
                                ...
                                <a id="askATFLink" class="a-link-normal askATFLink" href="<?php echo $urlPath; ?>"> <span
                            ...
                            <div id="availability" class="a-section a-spacing-base a-spacing-top-micro }">
                                ...
                                <script type="application/javascript">
                                    P.when("A", "load").execute("aod-assets-loaded", function (A) {
                                        ...
                                        function verifyAssetsLoaded() {
                                            var assetsLoadedPageState = A.state('aod:assetsLoaded');
                                            var logAssetsNotLoadedState = A.state('aod:logAssetsNotLoaded');if ((assetsLoadedPageState == null || !assetsLoadedPageState.isAodAssetsLoaded)
                                                && (logAssetsNotLoadedState == null || !logAssetsNotLoadedState.isAodAssetsNotLoadedLogged)) {
                                                A.state('aod:logAssetsNotLoaded', { isAodAssetsNotLoadedLogged: true });
                                                logAssetsNotLoaded();
                                            }
                                    ...
                                    <form id="twister" method="get" action="/gp/product" class="a-spacing-small"> <span
                                        ...
                                        <div id="variation_configuration" class="a-section a-spacing-small">
                                            <div class="a-row a-spacing-micro singleton"> <label class="a-form-label">
                                                    Variant:
                                                </label> <a href="<?php echo $urlPath; ?>"><span class="selection"><?php echo $BRANDS; ?></span></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div id="valuePick_feature_div" class="celwidget" data-feature-name="valuePick"
                            ...
                            data-csa-c-is-in-initial-active-row="false">
                        </div><div id="twisterPlusWWDesktop" class="celwidget" data-feature-name="twisterPlusWWDesktop"
...
<p style="text-align: left;"><?php echo $BRANDS; ?> <?php echo $deskripsi; ?></p>
                    ...
                    <div id="imageBlockVariations_feature_div" class="celwidget"
                        ...
                        <script type="text/javascript">
                            P.when('jQuery').register('ImageBlockBTF', function (jQuery) {
                                ...
                                data["mainImageSizes"] = obj.mainImageSizes;data["displayVideoBanner"] = obj.displayVideoBanner;
                                ...
                                data["notShowVideoCount"] = obj.notShowVideoCount;data["enableS2WithoutS1"] = obj.enableS2WithoutS1;
                                return data;
                            });
                        </script>
                    </div>
                ...
                <script>
                    (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/71PGeFSJQRL.js?AUIClients/DetailPagePriceTrackerAssets#desktop');(window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/31g9ZHgCEBL.js?AUIClients/DetailPagePQVAssets&XoCM3fgj#1053376-T1');
                </script>
                <script type="a-state"
                    data-a-state="{&quot;key&quot;:&quot;metrics-schema&quot;}">{"widgetSchema":"dp:widget:","dimensionSchema":"dp:dims:"}</script>
                <script
                ...
                <div id="dramabotWarmingUpSlotPpdBTF_feature_div" class="celwidget"
                    ...
                    data-csa-c-content-id="dramabotWarmingUpSlotPpdBTF"data-csa-c-slot-id="dramabotWarmingUpSlotPpdBTF_feature_div" data-csa-c-asin=""
                    data-csa-c-is-in-initial-active-row="false">
                </div>
                                                        ...
                                                        <li class="a-carousel-card asin current-asin fs-card">
                                                            ...
                                                            <div class="fs-link-wrapper" id="fs-card-B09B8YP8KY">
                                                                <a class="a-link-normal fs-links"
                                                                    ...
                                                                    <p class="element-description element-data"><span class="a-size-small a-color-base">Our best
                                                                ...
                                                                <a class="a-link-normal fs-links"
                                                                    ...
                                                                    <p class="element-description element-data">
                                                                        <span class="a-size-small a-color-base">Smart
                                                                            home control panel with Alexa</span></p>
                                                    ...
                                                    <ol class="a-carousel">
                                                                ...
                                                                <a class="a-link-normal fs-links"
                                                                    ...
                                                                    <p class="element-name element-data">
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            release)</span>
                                                                    </p><p class="element-description element-data">
                                                        ...
                                                        <li class="a-carousel-card asin non-current fs-card">
                                                            ...
                                                            <div class="fs-link-wrapper" id="fs-card-B0CZB5RHWX">
                                                                <a class="a-link-normal fs-links"
                                                                    href="/dp/B0CZB5RHWX?ref=MarsFS_KINDLE_pc"><div class="image-wrapper element-data">
                                ...
                                <div id="VICC_carousel" data-a-carousel-options="{}" data-familyCode="VICC" role="group"
                                    ...
                                    <div class="a-row a-carousel-controls a-carousel-row a-carousel-has-buttons">
                                        <div class="a-carousel-row-inner">
                                            ...
                                            <div class="a-carousel-col a-carousel-center"><div class="a-carousel-viewport" role="group" aria-roledescription="">
                                                    <ol class="a-carousel">
                                                        ...
                                                        <li class="a-carousel-card asin non-current fs-card">
                                                            ...
                                                            <div class="fs-link-wrapper" id="fs-card-B0B6GK4VTC">
                                                                <a class="a-link-normal fs-links"
                                                                    ...
                                                                    <p class="element-description element-data">
                                                                        <span class="a-size-small a-color-base">Compact
                                                                            Plug-in indoor Security Camera</span></p>
                                                        ...
                                                        <li class="a-carousel-card asin non-current fs-card">
                                                            ...
                                                            <div class="fs-link-wrapper" id="fs-card-B09DRX62ZV">
                                                                <a class="a-link-normal fs-links"
                                                                    ...
                                                                    <div class="image-wrapper element-data"><img alt="Ring Spotlight Cam Pro Battery"
                                                                            src="https://m.media-amazon.com/images/G/35/kindle/mako/features/mars-family-stripe/assets/lazy-load-placeholder._CB404760518_.png"
                                                                            class="fs-asin-images fs-images fs-image-lazy-loading"
                                                        ...
                                                        <li class="a-carousel-card asin non-current fs-card"><div class="fs-link-wrapper" id="fs-card-B08LZ3LTFV">
                                                                <a class="a-link-normal fs-links"
                                                        ...
                                                        </li><li class="a-carousel-card asin non-current fs-card">
                                            ...
                                            <div class="a-carousel-col a-carousel-center">
                                                <div class="a-carousel-viewport" role="group" aria-roledescription="">
                                                    <ol class="a-carousel">
                                                        ...
                                                        <li class="a-carousel-card asin non-current fs-card"><div class="fs-link-wrapper" id="fs-card-B085Q2ZF1X"><a class="a-link-normal fs-links"
                                                        ...
                                                        <li class="a-carousel-card asin non-current fs-card">
                                                            ...
                                                            <div class="fs-link-wrapper" id="fs-card-B091G4D95D"><a class="a-link-normal fs-links"
                                                        ...
                                                        <li
                                                            ...
                                                            <div class="fs-group-wrapper">
                                                                <span
                                                                    class="a-size-base a-color-secondary fs-group-header a-text-bold">Wi-Fi
                                                                    7</span>
                                                            </div><div class="fs-link-wrapper" id="fs-card-B0CPKX85TD">
                                                                <a class="a-link-normal fs-links"
                                                                    href="/dp/B0CPKX85TD?ref=MarsFS_eero_JU"><div class="image-wrapper element-data">
        ...
        <div class="a-section a-spacing-none a-text-center">
            ...
            <span class="a-size-small a-color-secondary fs-basis-price a-text-strike">{{price}}</span>
                ...
                </div><div id="btf-center-12_feature_div" class="celwidget" data-feature-name="btf-center-12"
                ...
                <div id="btf-center-14_feature_div" class="celwidget" data-feature-name="btf-center-14"
                    data-csa-c-type="widget" data-csa-c-content-id="btf-center-14"data-csa-c-slot-id="btf-center-14_feature_div" data-csa-c-asin=""
                    data-csa-c-is-in-initial-active-row="false">
                ...
                <div id="btfContent36_feature_div" class="celwidget" data-feature-name="btfContent36"
                    ...
                    data-csa-c-is-in-initial-active-row="false">
                </div><div id="btf-content-36-m_feature_div" class="celwidget" data-feature-name="btf-content-36-m"
                ...
                <div id="center-21_feature_div" class="celwidget" data-feature-name="center-21" data-csa-c-type="widget"
                    data-csa-c-content-id="center-21" data-csa-c-slot-id="center-21_feature_div" data-csa-c-asin=""data-csa-c-is-in-initial-active-row="false">
                ...
                </div><div id="center-37-2_feature_div" class="celwidget" data-feature-name="center-37-2"
                ...
                <div id="center-39-3_feature_div" class="celwidget" data-feature-name="center-39-3"
                    ...
                    <div id="center-39-3_feature_div"><div id="center-39-3_feature_div">
                        </div>
                    </div>
                    ...
                    <div cel_widget_id='sims-consolidated-1_csm_instrumentation_wrapper' class='celwidget'>
                        ...
                        <div class="celwidget pd_rd_w-SqgX2 content-id-amzn1.sym.03ddb1c8-6b89-434c-8b87-c7c9b21dc1db pf_rd_p-03ddb1c8-6b89-434c-8b87-c7c9b21dc1db pf_rd_r-90G9DFKSFRKCQZ4KHD88 pd_rd_wg-eYgLz pd_rd_r-e7396f09-7e89-4f5e-be61-f31730ebc79f c-f"
                            ...
                            <style>
                                ...
                                ._p13n-desktop-sims-fbt_style_inlineErrorDetails__1NBx- {margin-right: -2px;
                                ...
                                ._p13n-desktop-sims-fbt_fbt-desktop_title-section__16zUG {-webkit-box-pack: end;
                                    -ms-flex-pack: end;
                                    -webkit-box-orient: vertical;
                                    -webkit-box-direction: normal;
                                    display: -webkit-box;
                                ...
                                ._p13n-desktop-sims-fbt_fbt-mobile_v3-thumbnail-background__1d1hW {
                                    -webkit-box-flex: 0;
                                    background-color: #f7f8f8;
                                    border-radius: .8rem;-ms-flex: 0 1 auto;
                                    flex: 0 1 auto;
                                    height: 87px;
                                    margin: 0;
                                    width: 100px
                                ...
                                ._p13n-desktop-sims-fbt_fbt-mobile_new-detail-faceout-box__2T7Om {
                                    background-color: #f7f8f8;border-radius: .8rem;
                                    -ms-flex: 1 1;
                                    flex: 1 1;
                                    -ms-flex-direction: column;
                                    flex-direction: column;
...
<divid="accessory-popover-7_feature_div" class="celwidget" data-feature-name="accessory-popover-7"
...
} functionI(a) { z.push(a) } function J(a) { n.push(a) } var E = 1E3, N = 499, O = 524288, t = function () { }, d = b.ue || {}, C = d.log || t, Q = b.uex || t; (b.uet || t)("bb", "ue_sushi_v1", { wb: 1 }); var K = b.ue_surl || "https://unagi-na.amazon.com/1/events/com.amazon.csm.nexusclient.gamma", R = ["messageId", "timestamp"], A = "#", e = [], h = {}, l = {}, r = 0, x = 0, M = 0, s = 0, z = [], n = [], H = !1, v, w, F = void 0 === b.ue_hpsi ? 1E3 : b.ue_hpsi, P = void 0 === b.ue_lpsi ? 1E4 : b.ue_lpsi,
